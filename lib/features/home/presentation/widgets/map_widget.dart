...
import 'package:driver/common/app_constants.dart';
import 'package:driver/common/common.dart';
import 'package:driver/core/model/user_detail_model.dart';
import 'package:driver/core/utils/custom_button.dart';
import 'package:driver/core/utils/custom_divider.dart';
import 'package:driver/core/utils/custom_snack_bar.dart';
import 'package:driver/core/utils/custom_text.dart';
import 'package:driver/core/utils/custom_textfield.dart';
import 'package:driver/features/account/presentation/pages/account_page.dart';
import 'package:driver/features/account/presentation/pages/admin_chat.dart';
import 'package:driver/features/account/presentation/pages/earnings_page.dart';
import 'package:driver/features/account/presentation/pages/leaderboard_page.dart';
import 'package:driver/features/account/presentation/pages/owner_dashboard.dart';
import 'package:driver/features/account/presentation/widgets/top_bar.dart';
import 'package:driver/features/home/application/home_bloc.dart';
import 'package:driver/features/home/presentation/widgets/bidding_request_widget.dart';
import 'package:driver/features/home/presentation/widgets/bidding_ride_list_widget.dart';
import 'package:driver/features/home/presentation/widgets/cancel_reason_widget.dart';
import 'package:driver/features/home/presentation/widgets/chat_page_widget.dart';
import 'package:driver/features/home/presentation/widgets/custom_timer.dart';
import 'package:driver/features/home/presentation/widgets/on_ride_widget.dart';
import 'package:driver/features/home/presentation/widgets/accept_reject_widget.dart';
import 'package:driver/features/home/presentation/widgets/outstation_request_page.dart';
import 'package:driver/features/home/presentation/widgets/outstation_ride_list_widget.dart';
import 'package:driver/features/home/presentation/widgets/signature_painter_widget.dart';
import 'package:driver/features/home/presentation/widgets/avatar_glow.dart';
            ...
            ? Stack(
                children: [
                            ...
                            onMapCreated: (GoogleMapController controller) {
                              ...
                              if (Theme.of(context).brightness ==
                                ...
                                context
                                    ...
                                    .googleMapController!
                                    .setMapStyle(
                                        context.read<HomeBloc>().darkMapString);
                              } else {
                                context
                                    .read<HomeBloc>()
                                    .googleMapController!
                  ...
                  if (userData != null &&
                    ...
                    AnimatedPositioned(
                        ...
                        bottom: (bottomSize == size.height)
                            ? 0 + size.width * 0.25
                            : -((size.height - size.width * 0.65) - bottomSize),
                        child: GestureDetector(
                          onVerticalDragUpdate: (v) {
                            set(() {
                              ...
                              if (bottomSize > 250 &&
                                ...
                                _animatedWidget = earningsWidget(size, context);
                              }
                              // }
                            });
                          },
                          onVerticalDragEnd: (v) {
                            set(() {
                              if (bottomSize > 250) {
                                bottomSize = size.height - size.width * 0.65;
                                _animatedWidget =
                                    quickActions(size, context, set);
                              } else {
                                bottomSize = 0.0;
                          ...
                          child: Container(
                            ...
                            height: size.height,
                            padding: EdgeInsets.all(
                                (bottomSize <= 250) ? size.width * 0.05 : 0),
                            decoration: BoxDecoration(
                      ...
                      child: Column(
                        ...
                        children: [
                          ...
                          AnimatedCrossFade(
                              ...
                              secondChild: biddingRideListWidget(size, context),
                  ...
                  if (userData != null && userData!.metaRequest != null)
                    Positioned(
                        bottom: 0, child: acceptRejectWidget(size, context)),
                  if (context.read<HomeBloc>().choosenRide != null &&
                                        ...
                                        children: [
                                          ...
                                          SizedBox(
                                            ...
                                            child:
                                              ...
                                              animationType: pincodeanime
                                                  .AnimationType.fade,
                                              pinTheme: pincodeanime.PinTheme(
                                                shape: pincodeanime
                              ...
                              if (context
                                ...
                                if (userData!.onTripRequest!.transportType ==
                                  ...
                                  if (context.read<HomeBloc>().showImagePick ==
                                    ...
                                    if (userData!.onTripRequest == null ||
                                        userData!.onTripRequest!.isTripStart ==
                                            0) {
                                      if (context.read<HomeBloc>().loadImage !=
                                          null) {
                                        if (userData!.onTripRequest == null) {
                                          context
                                              .read<HomeBloc>()
                                  ...
                                  context.read<HomeBloc>().add(RideStartEvent(
                                      ...
                                      otp:
                                          context.read<HomeBloc>().rideOtp.text,
                                    ...
                                    child: GestureDetector(
                                      onTapDown: (val) {
                                        final box = context.findRenderObject()
                                            as RenderBox;
                                        final point = box
                                            .globalToLocal(val.globalPosition);
                                        context
                                            .read<HomeBloc>()
                          ...
                          CustomButton(
                              ...
                              onTap: () async {
                                if (context
                                  ...
                                  var _signatureImage = File('$path/$name.png');

                                  _signatureImage.writeAsBytesSync(uintImage);
